    ...
    >
      ...
      <Box>
        <HStack spacing={2} mb={2}>
          <Text textColor="gray.100" fontWeight={600} fontSize="lg">
            {title}
          </Text>
  ...
  return (
    <Flex justify={isUser ? "flex-end" : "flex-start"} w="100%">
      ...
      >
        ...
        <Text>{message}</Text>
        <Text fontSize="xs" color={isUser ? "black" : "gray.500"} mt={1}>
          {time}
        </Text>
      </Box>
    </Flex>
...
export default function LandingPage() {
  return (
    <Box bgGradient="linear(black, gray.800)" minH="100vh">
      {/* Hero Section */}
      <Container maxW="7xl" pt={10}>
          ...
          >
            ...
            >
              ...
              >
                ...
                />
                <ChatMessage
                  sender="Harshal Bhagat"
                  message="Yeah! look forward to try the new updated"
                  time="10:35 AM"
                  isUser={false}
                />
                <Box w="100%" textAlign="center">
                  <Badge textColor="white" colorScheme="black" fontSize="xs">
                    Sarah is typing...
                  </Badge>
                </Box>
              </VStack>
        ...
        <Box py={20}>
          <VStack spacing={2} textAlign="center" mb={12}>
            <Heading textColor="yellow.300" fontSize="4xl">
              Powerful Features
            </Heading>
